            ...
            <div className="grid-cols-3">
              ...
              <div className="navbar mb-8 shadow-lg bg-neutral text-neutral-content rounded-box">
                ...
                <div className="navbar-end">
                  ...
                  <a href="#fyi" style={{fontFamily: 'Montserrat', fontSize:'0.8rem'}} className=" btn-outline bg-[transparent] text-[#c73636] border-[#c73636] border-2 w-auto p-3 justify-center mx-[1rem] hover:bg-transparent hover:border-[#c73636] hover:bg-[#c73636] hover:text-white text-xs rounded-[5px]">
